/**
 * NativeBridge.java is the Java side of the JNI bridge, which part of the Java adapter.
 */
...
// JNI is only a transport. No Minecraft objects or detection rules here.
